 ...
 * @author mlebris2021
 * Servlet which the get and post method for the disconnect feature
 */
@WebServlet({ "/DisconnectServlet", "/deconnexion" })
public class DisconnectServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String urlEncode = response.encodeURL(request.getContextPath() + ACCUEIL_PAGE);
